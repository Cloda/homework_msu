...
double g2(double x) { return exp(-1000 * x); }

double g3(double x) { return 1 / sqrt(1 - x * x); }
...
int main(int argc, char *argv[]){
    double a, b;
    int N, i, step_for_asimptotics = 50;
    ...
    std::cout << "       Sympson" << "           | " << "   Gauss" << std::endl << std::endl;
    printf("f0: %20.15lf | %20.15lf\n", SimpsonIntegr(a, b, f0), GaussIntegr(a, b, f0));
    ...
    printf("f1: %20.15lf | %20.15lf\n", SimpsonIntegr(a, b, f1), GaussIntegr(a, b, f1));
    ...
    printf("f2: %20.15lf | %20.15lf\n", SimpsonIntegr(a, b, f2), GaussIntegr(a, b, f2));
    ...
    printf("f3: %20.15lf | %20.15lf\n", SimpsonIntegr(a, b, f3), GaussIntegr(a, b, f3));
    ...
    printf("f5: %20.15lf | %20.15lf\n", SimpsonIntegr(a, b, f5), GaussIntegr(a, b, f5));
    ...
    std::cout << "INTEGRTION NEXT" << std::endl;
